...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 z-1 w-full flex justify-between items-start overflow-x-hidden'>
            <div className='p-2 lg:p-4 w-28 md:w-32 lg:w-40 '>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103 44" fill='white'>
            ...
            <div
                ...
                className='bg-black cursor-pointer w-36 h-11 md:w-52 md:h-12 lg:w-55 relative' //parent div
            >
